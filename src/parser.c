...
static const TSMapSlice ts_supertype_map_slices[] = {
  [sym__collection_value] = {.index = 0, .length = 2},
  [sym__expr_term] = {.index = 2, .length = 11},
  [sym__expression] = {.index = 13, .length = 2},
  [sym__literal_value] = {.index = 15, .length = 4},
  [sym__operation] = {.index = 19, .length = 2},
  [sym__splat] = {.index = 21, .length = 2},
  [sym__template_directive] = {.index = 23, .length = 2},
  [sym__template_expr] = {.index = 25, .length = 2},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(sym_identifier_character_set_1, 678, lookahead)) ADVANCE(59);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 11,
    ...
    case 47:
      ...
      if (set_contains(sym_identifier_character_set_2, 794, lookahead)) ADVANCE(59);
      END_STATE();
    case 48:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == 'a') ADVANCE(51);
